...
public class Department extends TableImpl<DepartmentRecord> {
    ...
    private static final long serialVersionUID = -819471382;
    ...
    /**
     * The column <code>DEPARTMENT.ID</code>.
     */
    ...
    /**
     * The column <code>DEPARTMENT.NO</code>.
     */
    public final TableField<DepartmentRecord, String> NO = createField("no", org.jooq.impl.SQLDataType.CHAR(4).nullable(false), this, "");
